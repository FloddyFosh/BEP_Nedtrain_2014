...
Group::Group() : estFlex(0), lstFlex(0), est(-1), lst(-1), st(-1), job(-1), duration(0), locked (false) { }

Group::Group(int j, int est, int lst, int st) : estFlex(0), lstFlex(0), est(est), lst(lst), st(st), job(j), duration(0), locked (false) {}
