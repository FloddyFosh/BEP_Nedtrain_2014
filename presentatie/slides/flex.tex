...
\begin{frame}\frametitle{Flexibiliteit (2)}
    ...
    \begin{tikzpicture}
        ...
        \filldraw[very thick, draw=darkblue,fill=lightblue, visible on=<1-2>] (55mm, 2mm) rectangle (75mm, 8mm);

        % aan het begin
        \filldraw[very thick, draw=darkgreen,fill=lightgreen, visible on=<3>] (0mm, 14mm) rectangle (25mm, 20mm);
        \filldraw[very thick, draw=darkblue,fill=lightblue, visible on=<3>] (25mm, 2mm) rectangle (45mm, 8mm);

        % aan het einde
        \filldraw[very thick, draw=darkgreen,fill=lightgreen, visible on=<4->] (55mm, 14mm) rectangle (80mm, 20mm);
        \filldraw[very thick, draw=darkblue,fill=lightblue, visible on=<4->] (80mm, 2mm) rectangle (100mm, 8mm);
        ...
        \draw [line width=1.2mm, ->, visible on=<2>] (22mm, 17mm) -- (65mm, 5mm);
        \draw [line width=0.5mm, ->, visible on=<2>, white] (22.3mm, 16.9mm) -- (64.5mm, 5.1mm);
    \end{tikzpicture}
\end{frame}
...
\begin{frame}\frametitle{Flexibiliteit (3)}
    ...
    \begin{tikzpicture}
        ...
        \filldraw[very thick, draw=darkblue,fill=lightblue] (55mm, 2mm) rectangle (75mm, 8mm);
