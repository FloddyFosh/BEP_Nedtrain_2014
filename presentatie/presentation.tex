...
\input{slides/inhoudsopgave}
\input{slides/opdrachtgever}
\input{slides/roosterprobleem}
\input{slides/nedtrainplanner}
\input{slides/opdrachtomschrijving}
\input{slides/aanpak}
\input{slides/flex}
\input{slides/linearprogramming}
\input{slides/chaining}
\input{slides/interface}
\input{slides/demo}
\input{slides/sig}
\input{slides/conclusie}
\input{slides/vragen}
