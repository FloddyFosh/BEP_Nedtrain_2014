...
Alle tests die gemaakt zijn, maken gebruiken van het Google Test framework. Dit was erg prettig in het gebruik en het uitbreiden van de testsuite ging redelijk eenvoudig. We hebben er voor gekozen om voor de solver een aparte testsuite te maken en deze niet te integreren met de bestaande testsuite voor de interface. Dit heeft als voordeel dat de testsuites net als de interface en solver zelf apart gebruikt kunnen worden. Voor de solver hebben we $42$ tests gemaakt. 
...
Van de code die op vrijdag 13 juni is opgestuurd, is het volgende commentaar ontvangen.
