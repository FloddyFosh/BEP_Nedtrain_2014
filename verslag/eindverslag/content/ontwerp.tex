...
\begin{itemize}
    ...
    \item \texttt{PC}: duidt aan dat een voorrangsrelatie toegevoegd wordt. De syntax is als volgt: \texttt{\textquoteleft PC: <i1> <j1> <i2> <j2>\textquoteright}, waarbij \texttt{<i1> <j1>} de voorgaangde taak aanduidt, en \texttt{<i2> <j2>} de opvolgende taak.
